...
class PropertyManager {
    ...
    public boolean getIsClearPassword() {
        return isClearPassword;
    }
...
// Mock PasswordDigestUtil class
class PasswordDigestUtil {
    public static String doPasswordDigest(String password) {
        // Mock password digest (SHA1 hash)
