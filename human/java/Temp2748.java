    ...
    public static void main(String[] args) {
        try {
            final String PUBLIC_KEY_PEM = "MIIBtzCCASsGByqGSM44BAEwggEeAoGBAJLJRIrDdiwbB6iWZTWowprJB8QfbLK7\n"
                                        ...
                                        + "d6AFgUd73b+Obh8=\n";
            byte[] decodedKey = Base64.getDecoder().decode(PUBLIC_KEY_PEM.replaceAll("\\n", ""));
            KeyFactory.getInstance("DSA").generatePublic(new X509EncodedKeySpec(decodedKey));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
