This is not C code, it's Java code. However, I can provide you with the corrected Java code that is compilable:
...
If you need C code, please provide the C code that needs correction.