...
$crypt = new MyProjCrypt('my_secret_key');
$crypt->encrypt('Hello, World!');
echo "Encrypted: " . $crypt->getEncryptedString() . "\n";
$crypt->decrypt($crypt->getEncryptedString());
echo "Decrypted: " . $crypt->getDecryptedString() . "\n";
