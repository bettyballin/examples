Here is the PHP code in executable format:
    ...
    <fieldset class="radio">
      <legend>Transport encoding</legend>
        <label for="ciphertext-trans-base64">
          <input id="ciphertext-trans-base64" name="ciphertext-trans" type="radio" value="base64" <?php radioChecked($ciphertext_trans,'base64',True); ?>>base64
        </label>
        <label for="ciphertext-trans-hex">
          <input id="ciphertext-trans-hex" name="ciphertext-trans" type="radio" value="hex" <?php radioChecked($ciphertext_trans,'hex',False); ?>>hex
        </label>
    </fieldset>
  ...
  <fieldset>
    ...
    <fieldset class="radio">
      <legend>Chaining mode</legend>
        <label for="chain-cfb">
          <input id="chain-cfb" name="chain" type="radio" value="CFB" <?php radioChecked($chain,'CFB',True); ?>>CFB
        </label>
        <label for="chain-cbc">
          <input id="chain-cbc" name="chain" type="radio" value="CBC" <?php radioChecked($chain,'CBC',False); ?>>CBC
        </label>
        <label for="chain-ecb">
          <input id="chain-ecb" name="chain" type="radio" value="ECB" <?php radioChecked($chain,'ECB',False); ?>>ECB
        </label>
    </fieldset>
    ...
    <fieldset class="radio">
      <legend>Cipher</legend>
        <label for="aes-128">
          <input id="aes-128" name="cipherIn" type="radio" value="AES-128" <?php radioChecked($cipherIn,'AES-128',True); ?>>AES-128
        </label>
